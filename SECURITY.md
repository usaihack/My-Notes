...
2. Open a private security advisory via GitHub's [Security tab](https://github.com/usaihack/My-Notes/security/advisories/new)
3. Include:
   - Which file / note is affected
   - What the issue is
   - Steps to reproduce
...
```
usaihack@kali:~$ echo "Stay ethical. Stay sharp." && exit
```
